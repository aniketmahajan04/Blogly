...
const PostDetailPage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">The post you're looking for might have been removed or doesn't exist.</p>
          <Link to="/" className="px-6 py-3 bg-teal-600 text-white font-semibold rounded-md hover:bg-teal-700 transition-colors">
            Return Home
          </Link>
        </div>
      </div>
  ...
  const renderContent = () => {
    ...
    html = html.replace(/## (.*?)(?:\n|$)/g, '<h2 class="text-2xl font-bold my-3">$1</h2>');
    html = html.replace(/### (.*?)(?:\n|$)/g, '<h3 class="text-xl font-bold my-2">$1</h3>');
    ...
    // Code blocks
    html = html.replace(/```(.*?)```/gs, '<pre class="bg-gray-100 p-4 rounded-md my-4 overflow-x-auto">$1</pre>');
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between py-4 border-b border-t border-gray-100">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <Heart className={post.isLiked ? 'fill-red-500' : ''} size={18} />
