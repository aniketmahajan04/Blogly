import { Bookmark, Eye, Heart, LogOut, MessageCircle, PenSquare, Trash2, View } from "lucide-react";
          ...
          <div className="flex items-center p-2 w-[90%] mt-5 rounded-lg">
            <div className="h-20 w-20 bg-white rounded-full flex items-center justify-center ml-4">
              <img
                src={
                  user.image ??
                  "https://unsplash.com/photos/frog-staring-intensely-with-detailed-eyes-CbAPNRuVyUk"
                }
                alt="Profile"
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 ">
                        <div className="flex justify-center space-x-4">
                          <span className="flex items-center">
                            <span className="mr-1"><Heart size={18}/></span> 53
                          </span>
                          <span className="flex items-center">
                            <span className="mr-1"><MessageCircle size={18}/></span> 20
                          </span>
                          <span className="flex items-center">
                            <span className="mr-1"><Eye size={18}/></span> 2
                          </span>
                        </div>
                      </td>
